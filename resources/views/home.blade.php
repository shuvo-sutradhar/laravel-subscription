...
@section('content')
    ...
    <section class="font-sans container m-auto flex px-5">
        ...
        <div class="flex-1 flex items-start flex-col justify-center">
            <h1 class="my-4 font-medium mt-40 lg:mt-32 lg:mt-0 text-center w-full px-2 text-gray-800 text-2xl xl:text-5xl lg:px-0 font-black mb-8 md:w-full lg:text-left h-auto xl:h-32"><span class="block">A Course Platform</span> <span id="title" class="text-pink-500"></span></h1>
    ...
    <section class="text-center pt-32 pb-40 bg-pink-500 relative">
        ...
        <div class="container mx-auto text-center px-5">
            <h1 class="w-full my-2 text-2xl sm:text-3xl lg:text-5xl font-bold leading-tight text-left sm:text-center text-white">Sign up to create your first course!</h1>
            <h3 class="my-4 mb-6 lg:mb-4 text-xl lg:text-3xl leading-tight text-gray-200 text-left sm:text-center">Signup below to get started.</h3>
            <a href="/register" class="px-8 py-4 bg-indigo-500 rounded-full mt-8 inline-block text-lg text-white font-bold shadow-xl">Get Started</a>
        </div>
    ...
    <script>
        ...
        var typed = new Typed('#title', {
            strings: ["for Hipster Developers.", "Awesome Developers.", "Like minded gigs."],
            typeSpeed: 60,
            backSpeed: 20,
            backDelay: 1500,
            startDelay: 0,
